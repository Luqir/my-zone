...
:::tip
一些 JavaScript 常用的 API 代码，有 DOM 操作、CSS 操作、对象（Object 对象、Array 对象、Number 对象、String 对象、Math 对象、JSON 对象和 Console 对象）操作。
:::
...
<!-- >转载自：[https://www.kancloud.cn/dennis/tgjavascript/241852](https://www.kancloud.cn/dennis/tgjavascript/241852) -->